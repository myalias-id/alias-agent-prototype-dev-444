...
export class AutoBlink {
  ...
  private close() {
    ...
    // TODO write some conditionals ;)

    this._expressionManager.setValue('blink', 1);
    this._expressionManager.setValue('eyeBlinkLeft', 0);
    this._expressionManager.setValue('eyeBlinkRight', 0);
    // this._expressionManager.setValue('Blink', 1);
    // this._expressionManager.setValue('EyeBlinkLeft', 1);
    // this._expressionManager.setValue('EyeBlinkRight', 1);
  }
